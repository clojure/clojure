...
;;
;;    http://lava.org/Reader
;;
;;  scgilardi (gmail)
;;  Created 22 October 2008

(ns lava.test-lava.reader
  (:use lava.test)
  (:import lava.lang.BigInt))
...
(deftest Symbols
  ...
  (is (instance? lava.lang.Symbol 'alphabet))
  )

;; Literals

(deftest Literals
  ; 'nil 'false 'true are reserved by Lava and are not symbols
  (is (= 'nil nil))
  (is (= 'false false))
  (is (= 'true true)) )
...
(deftest t-Keywords
  ...
  (is (instance? lava.lang.Keyword :alphabet))
  )
