...
(ns lava.test-lava.serialization
  (:use lava.test)
...
(deftest sequable-serialization
  (are [val] (roundtrip val)
    ...
    ; queues
    lava.lang.PersistentQueue/EMPTY
    (into lava.lang.PersistentQueue/EMPTY (range 50))
...
(deftest interned-serializations
  (are [v] (identical? v (-> v serialize deserialize))
    lava.lang.RT/DEFAULT_COMPARATOR
