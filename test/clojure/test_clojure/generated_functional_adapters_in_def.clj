...
(ns clojure.test-clojure.generated-functional-adapters-in-def
  ...
  (deftest functional-adapters-in-def
           ...
           (is (= (.methodZ ^AdapterExerciser exerciser Zadapter) "Z"))
           ...
           (is (= (.methodLZ ^AdapterExerciser exerciser LZadapter) "LZ"))
           (def DZadapter (fn [^double a] false))
           (is (= (.methodDZ ^AdapterExerciser exerciser DZadapter) "DZ"))
           (def OZadapter (fn [^AdapterExerciser a] false))
           (is (= (.methodOZ ^AdapterExerciser exerciser OZadapter) "OZ"))
           ...
           (is (= (.methodLLZ ^AdapterExerciser exerciser LLZadapter) "LLZ"))
           (def LOZadapter (fn [^long a ^AdapterExerciser b] false))
           (is (= (.methodLOZ ^AdapterExerciser exerciser LOZadapter) "LOZ"))
           (def OLZadapter (fn [^AdapterExerciser a ^long b] false))
           (is (= (.methodOLZ ^AdapterExerciser exerciser OLZadapter) "OLZ"))
           (def DDZadapter (fn [^double a ^double b] false))
           (is (= (.methodDDZ ^AdapterExerciser exerciser DDZadapter) "DDZ"))
           (def LDZadapter (fn [^long a ^double b] false))
           (is (= (.methodLDZ ^AdapterExerciser exerciser LDZadapter) "LDZ"))
           (def DLZadapter (fn [^double a ^long b] false))
           (is (= (.methodDLZ ^AdapterExerciser exerciser DLZadapter) "DLZ"))
           (def OOZadapter (fn [^AdapterExerciser a ^AdapterExerciser b] false))
           (is (= (.methodOOZ ^AdapterExerciser exerciser OOZadapter) "OOZ"))
           (def ODZadapter (fn [^AdapterExerciser a ^double b] false))
           (is (= (.methodODZ ^AdapterExerciser exerciser ODZadapter) "ODZ"))
           (def DOZadapter (fn [^double a ^AdapterExerciser b] false))
           (is (= (.methodDOZ ^AdapterExerciser exerciser DOZadapter) "DOZ"))
           ...
           (is (= (.methodOOOZ ^AdapterExerciser exerciser OOOZadapter) "OOOZ"))
           ...
           (is (= (.methodOOOOZ ^AdapterExerciser exerciser OOOOZadapter) "OOOOZ"))
           ...
           (is (= (.methodOOOOOZ ^AdapterExerciser exerciser OOOOOZadapter) "OOOOOZ"))
           ...
           (is (= (.methodOOOOOOZ ^AdapterExerciser exerciser OOOOOOZadapter) "OOOOOOZ"))
           ...
           (is (= (.methodOOOOOOOZ ^AdapterExerciser exerciser OOOOOOOZadapter) "OOOOOOOZ"))
           ...
           (is (= (.methodOOOOOOOOZ ^AdapterExerciser exerciser OOOOOOOOZadapter) "OOOOOOOOZ"))
           ...
           (is (= (.methodOOOOOOOOOZ ^AdapterExerciser exerciser OOOOOOOOOZadapter) "OOOOOOOOOZ"))
           ...
           (is (= (.methodOOOOOOOOOOZ ^AdapterExerciser exerciser OOOOOOOOOOZadapter) "OOOOOOOOOOZ"))
