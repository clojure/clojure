...
var tag_3,v_10,attrs_4,elem_6,body_5,vec__534_8,k_9,vec__533_2,sq__3739__auto___7;
...
((clojure.core.map_QMARK_.apply(null,[attrs_4]))?(((function(){var _rtn,_cnt;(sq__3739__auto___7=clojure.core.seq.apply(null,[attrs_4]));do{_cnt=0;
_rtn=((sq__3739__auto___7)?(((vec__534_8=clojure.core.first.apply(null,[sq__3739__auto___7])),
...
(_cnt=1,_rtn=[clojure.core.rest.apply(null,[sq__3739__auto___7])],sq__3739__auto___7=_rtn[0])):(null)))):(null))}while(_cnt);return _rtn;})())):(null)),
...
var sq__3739__auto___3,i_4;
return (((function(){var _rtn,_cnt;(sq__3739__auto___3=clojure.core.seq.apply(null,[jsrepl.dom.apply(null,[v_2])]));do{_cnt=0;
_rtn=((sq__3739__auto___3)?(((i_4=clojure.core.first.apply(null,[sq__3739__auto___3])),
((true)?(((true)?((parent_1).appendChild(i_4)):(null)),
(_cnt=1,_rtn=[clojure.core.rest.apply(null,[sq__3739__auto___3])],sq__3739__auto___3=_rtn[0])):(null)))):(null))}while(_cnt);return _rtn;})()),
parent_1)})))}).apply(null,[]);
(function(){
...
var sq__3739__auto___3,line_4;
return (((function(){var _rtn,_cnt;(sq__3739__auto___3=clojure.core.seq.apply(null,[(text_2).split((/\n/))]));do{_cnt=0;
_rtn=((sq__3739__auto___3)?(((line_4=clojure.core.first.apply(null,[sq__3739__auto___3])),
...
var or__3087__auto___2,vec__596_2,status_name_3,text_4;
return (((clojure.lang.Numbers.equiv(clojure.JS.getOrRun(((or__3087__auto___2=ev_1),
((or__3087__auto___2)?(or__3087__auto___2):(clojure.JS.resolveVar("event",jsrepl)))),"keyCode"),(13)))?(((vec__596_2=(applet_4).tojs(clojure.JS.getOrRun(input_2,"value"))),
