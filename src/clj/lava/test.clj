...
;;; test.clj: test framework for Lava
...
(ns 
  ...
  Chas Emerick, Allen Rohner, and Stuart Halloway",
   ...
   As of Lava SVN rev. 1221, this does not work with defmacro.
   See http://code.google.com/p/lava/issues/detail?id=51
...
(defmacro are
  ...
  See lava.template/do-template for an explanation of
  templates.
