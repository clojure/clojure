           ...
           (startElement [uri local-name q-name ^Attributes atts]
             (let [attrs (fn [ret i]
                           (if (neg? i)
                             ret
                             (recur (assoc ret
                                           (lava.lang.Keyword/intern (symbol (.getQName atts i)))
                                           (.getValue atts (int i)))
                                    (dec i))))
                   e (struct element
                             (. lava.lang.Keyword (intern (symbol q-name)))
...
;(load-file "/Users/rich/dev/lava/src/xml.clj")
