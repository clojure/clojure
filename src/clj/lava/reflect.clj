...
* Canonicalizes class names as Lava symbols. Types can extend
  to the TypeReference protocol to indicate that they can be
  unambiguously resolved as a type name. The canonical format
  requires one non-Java-ish convention: array brackets are <>
  instead of [] so they can be part of a Lava symbol.
...
(defn type-reflect
  ...
  :members. In the discussion below, names are always Lava symbols.
