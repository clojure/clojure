...
(ns ^{:doc "Lava String utilities

It is poor form to (:use lava.string). Instead, use require
with :as to specify a prefix, e.g.

(ns your.namespace.here
  (:require [lava.string :as str]))

Design notes for lava.string:
...
4. When a function is documented to accept a string argument, it
  ...
  lava.string
  (:refer-lava :exclude (replace reverse))
  (:import (java.util.regex Pattern)
           lava.lang.LazilyPersistentVector))
