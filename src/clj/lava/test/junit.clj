...
;; test/junit.clj: Extension to lava.test for JUnit-compatible XML output
...
(ns ^{:doc "lava.test extension for JUnit-compatible XML output.
  ...
  To use, wrap any calls to lava.test/run-tests in the
  ...
  To write the output to a file, rebind lava.test/*test-out* to
  your own PrintWriter (perhaps opened using
  lava.java.io/writer)."
  :author "Jason Sankey"}
  lava.test.junit
  (:require [lava.stacktrace :as stack]
            [lava.test :as t]))

;; copied from lava.contrib.lazy-xml
(def ^{:private true}
     escape-xml-map
