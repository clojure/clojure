...
// named by the Java System property "lava.compile.path". Arguments are
// strings naming the libs to be compiled. The libs and compile-path must
// all be within CLASSPATH.

public class Compile{

private static final String PATH_PROP = "lava.compile.path";
private static final String REFLECTION_WARNING_PROP = "lava.compile.warn-on-reflection";
private static final String UNCHECKED_MATH_PROP = "lava.compile.unchecked-math";
private static final Var compile_path = RT.var("lava.core", "*compile-path*");
private static final Var compile = RT.var("lava.core", "compile");
private static final Var warn_on_reflection = RT.var("lava.core", "*warn-on-reflection*");
private static final Var unchecked_math = RT.var("lava.core", "*unchecked-math*");
