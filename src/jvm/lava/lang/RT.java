...
//												  Symbol.intern("RT"), "lava.lang.RT",
//                                                  Symbol.intern("Num"), "lava.lang.Num",
//                                                  Symbol.intern("Symbol"), "lava.lang.Symbol",
//                                                  Symbol.intern("Keyword"), "lava.lang.Keyword",
//                                                  Symbol.intern("Var"), "lava.lang.Var",
//                                                  Symbol.intern("Ref"), "lava.lang.Ref",
//                                                  Symbol.intern("IFn"), "lava.lang.IFn",
//                                                  Symbol.intern("IObj"), "lava.lang.IObj",
//                                                  Symbol.intern("ISeq"), "lava.lang.ISeq",
//                                                  Symbol.intern("IPersistentCollection"),
//                                                  "lava.lang.IPersistentCollection",
//                                                  Symbol.intern("IPersistentMap"), "lava.lang.IPersistentMap",
//                                                  Symbol.intern("IPersistentList"), "lava.lang.IPersistentList",
//                                                  Symbol.intern("IPersistentVector"), "lava.lang.IPersistentVector",
...
static public final Namespace LAVA_NS = Namespace.findOrCreate(Symbol.intern("lava.core"));
//static final Namespace USER_NS = Namespace.findOrCreate(Symbol.intern("user"));
final static public Var OUT =
		Var.intern(LAVA_NS, Symbol.intern("*out*"), new OutputStreamWriter(System.out)).setDynamic();
final static public Var IN =
		Var.intern(LAVA_NS, Symbol.intern("*in*"),
		           new LineNumberingPushbackReader(new InputStreamReader(System.in))).setDynamic();
final static public Var ERR =
		Var.intern(LAVA_NS, Symbol.intern("*err*"),
		           new PrintWriter(new OutputStreamWriter(System.err), true)).setDynamic();
final static Keyword TAG_KEY = Keyword.intern(null, "tag");
final static public Var AGENT = Var.intern(LAVA_NS, Symbol.intern("*agent*"), null).setDynamic();
final static public Var READEVAL = Var.intern(LAVA_NS, Symbol.intern("*read-eval*"), T).setDynamic();
final static public Var ASSERT = Var.intern(LAVA_NS, Symbol.intern("*assert*"), T).setDynamic();
final static public Var MATH_CONTEXT = Var.intern(LAVA_NS, Symbol.intern("*math-context*"), null).setDynamic();
...
final static public Var USE_CONTEXT_CLASSLOADER =
		Var.intern(LAVA_NS, Symbol.intern("*use-context-classloader*"), T).setDynamic();
//boolean
static final public Var UNCHECKED_MATH = Var.intern(Namespace.findOrCreate(Symbol.intern("lava.core")),
                                                   Symbol.intern("*unchecked-math*"), Boolean.FALSE).setDynamic();

//final static public Var CURRENT_MODULE = Var.intern(Symbol.intern("lava.core", "current-module"),
//                                                    Module.findOrCreateModule("lava/user"));
...
final static Var CMD_LINE_ARGS = Var.intern(LAVA_NS, Symbol.intern("*command-line-args*"), null).setDynamic();
//symbol
final public static Var CURRENT_NS = Var.intern(LAVA_NS, Symbol.intern("*ns*"),
                                                LAVA_NS).setDynamic();

final static Var FLUSH_ON_NEWLINE = Var.intern(LAVA_NS, Symbol.intern("*flush-on-newline*"), T).setDynamic();
final static Var PRINT_META = Var.intern(LAVA_NS, Symbol.intern("*print-meta*"), F).setDynamic();
final static Var PRINT_READABLY = Var.intern(LAVA_NS, Symbol.intern("*print-readably*"), T).setDynamic();
final static Var PRINT_DUP = Var.intern(LAVA_NS, Symbol.intern("*print-dup*"), F).setDynamic();
final static Var WARN_ON_REFLECTION = Var.intern(LAVA_NS, Symbol.intern("*warn-on-reflection*"), F).setDynamic();
final static Var ALLOW_UNRESOLVED_VARS = Var.intern(LAVA_NS, Symbol.intern("*allow-unresolved-vars*"), F).setDynamic();

final static Var IN_NS_VAR = Var.intern(LAVA_NS, Symbol.intern("in-ns"), F);
final static Var NS_VAR = Var.intern(LAVA_NS, Symbol.intern("ns"), F);
final static Var FN_LOADER_VAR = Var.intern(LAVA_NS, Symbol.intern("*fn-loader*"), null).setDynamic();
static final Var PRINT_INITIALIZED = Var.intern(LAVA_NS, Symbol.intern("print-initialized"));
static final Var PR_ON = Var.intern(LAVA_NS, Symbol.intern("pr-on"));
//final static Var IMPORTS = Var.intern(LAVA_NS, Symbol.intern("*imports*"), DEFAULT_IMPORTS);
...
public static void loadResourceScript(Class c, String name, boolean failIfNotFound) throws IOException{
	...
	if(ins != null) {
		...
		throw new FileNotFoundException("Could not locate Lava resource on classpath: " + name);
	}
}
...
static void compile(String cljfile) throws IOException{
	...
	if(ins != null) {
		...
		throw new FileNotFoundException("Could not locate Lava resource on classpath: " + cljfile);
}
...
static void doInit() throws ClassNotFoundException, IOException{
	...
	try {
		...
		Symbol LAVA = Symbol.intern("lava.core");

		Var in_ns = var("lava.core", "in-ns");
		Var refer = var("lava.core", "refer");
		in_ns.invoke(USER);
		refer.invoke(LAVA);
