...
import lava.asm.*;
import lava.asm.commons.Method;
import lava.asm.commons.GeneratorAdapter;
//*/
/*
...
static final Symbol IMPORT = Symbol.intern("lava.core", "import*");
...
//static final Symbol SYNTAX_QUOTE = Symbol.intern("lava.core", "syntax-quote");
static final Symbol LIST = Symbol.intern("lava.core", "list");
static final Symbol HASHMAP = Symbol.intern("lava.core", "hash-map");
static final Symbol VECTOR = Symbol.intern("lava.core", "vector");
static final Symbol IDENTITY = Symbol.intern("lava.core", "identity");

static final Symbol _AMP_ = Symbol.intern("&");
static final Symbol ISEQ = Symbol.intern("lava.lang.ISeq");
...
//static final Symbol IFN = Symbol.intern("lava.lang", "IFn");
...
//String
static final public Var SOURCE = Var.intern(Namespace.findOrCreate(Symbol.intern("lava.core")),
                                            Symbol.intern("*source-path*"), "NO_SOURCE_FILE").setDynamic();

//String
static final public Var SOURCE_PATH = Var.intern(Namespace.findOrCreate(Symbol.intern("lava.core")),
                                                 Symbol.intern("*file*"), "NO_SOURCE_PATH").setDynamic();

//String
static final public Var COMPILE_PATH = Var.intern(Namespace.findOrCreate(Symbol.intern("lava.core")),
                                                  Symbol.intern("*compile-path*"), null).setDynamic();
//boolean
static final public Var COMPILE_FILES = Var.intern(Namespace.findOrCreate(Symbol.intern("lava.core")),
                                                   Symbol.intern("*compile-files*"), Boolean.FALSE).setDynamic();

static final public Var INSTANCE = Var.intern(Namespace.findOrCreate(Symbol.intern("lava.core")),
                                            Symbol.intern("instance?"));

static final public Var ADD_ANNOTATIONS = Var.intern(Namespace.findOrCreate(Symbol.intern("lava.core")),
...
static class DefExpr implements Expr{
	...
	final static Method setTagMethod = Method.getMethod("void setTag(lava.lang.Symbol)");
	final static Method setMetaMethod = Method.getMethod("void setMeta(lava.lang.IPersistentMap)");
	final static Method setDynamicMethod = Method.getMethod("lava.lang.Var setDynamic(boolean)");
	final static Method symintern = Method.getMethod("lava.lang.Symbol intern(String, String)");
...
static public abstract class HostExpr implements Expr, MaybePrimitiveExpr{
	...
	final static Method fromIntMethod = Method.getMethod("lava.lang.Num from(int)");
	final static Method fromLongMethod = Method.getMethod("lava.lang.Num from(long)");
	final static Method fromDoubleMethod = Method.getMethod("lava.lang.Num from(double)");
...
public static class MetaExpr implements Expr{
	...
	public final Expr meta;
	final static Type IOBJ_TYPE = Type.getType(IObj.class);
	final static Method withMetaMethod = Method.getMethod("lava.lang.IObj withMeta(lava.lang.IPersistentMap)");
...
public static class ListExpr implements Expr{
	public final IPersistentVector args;
	final static Method arrayToListMethod = Method.getMethod("lava.lang.ISeq arrayToList(Object[])");
...
public static class MapExpr implements Expr{
	...
	final static Method mapMethod = Method.getMethod("lava.lang.IPersistentMap map(Object[])");
...
public static class SetExpr implements Expr{
	...
	final static Method setMethod = Method.getMethod("lava.lang.IPersistentSet set(Object[])");
...
public static class VectorExpr implements Expr{
	public final IPersistentVector args;
	final static Method vectorMethod = Method.getMethod("lava.lang.IPersistentVector vector(Object[])");
...
static class KeywordInvokeExpr implements Expr{
    ...
    public void emit(C context, ObjExpr objx, GeneratorAdapter gen){
        ...
        gen.invokeInterface(ObjExpr.ILOOKUP_SITE_TYPE,
                            Method.getMethod("lava.lang.ILookupThunk fault(Object)"));    //target,new-thunk
...
static class StaticInvokeExpr implements Expr, MaybePrimitiveExpr{
	...
	public void emitUnboxed(C context, ObjExpr objx, GeneratorAdapter gen){
		...
		if(variadic)
			...
			gen.invokeStatic(Type.getType(ArraySeq.class), Method.getMethod("lava.lang.ArraySeq create(Object[])"));
			}
		else
...
//			loader.registerConstants(fn.constantsID, fn.constants.toArray());
		...
		try
			{
			fn.compile(fn.isVariadic() ? "lava/lang/RestFn" : "lava/lang/AFunction",
			           (prims.size() == 0)?
			            null
	...
	public void emitForDefn(ObjExpr objx, GeneratorAdapter gen){
		if(!hasPrimSigs && closes.count() == 0)
			...
			gen.invokeConstructor(thunkType,Method.getMethod("void <init>(lava.lang.Var,String)"));
			}
		else
...
//	}
	...
	final static Method kwintern = Method.getMethod("lava.lang.Keyword intern(String, String)");
	final static Method symintern = Method.getMethod("lava.lang.Symbol intern(String)");
	final static Method varintern =
			Method.getMethod("lava.lang.Var intern(lava.lang.Symbol, lava.lang.Symbol)");
...
//		         (isVariadic() ? "lava/lang/RestFn" : "lava/lang/AFunction"), null);
		String source = (String) SOURCE.deref();
...
//			}
		...
		for(int i=0;i<varCallsites.count();i++)
			...
			clinitgen.invokeStatic(RT_TYPE, Method.getMethod("lava.lang.Var var(String,String)"));
			clinitgen.dup();
...
//			}
		...
		if(supportsMeta())
			...
			//meta()
			Method meth = Method.getMethod("lava.lang.IPersistentMap meta()");
			...
			//withMeta()
			meth = Method.getMethod("lava.lang.IObj withMeta(lava.lang.IPersistentMap)");
		...
		if(keywordCallsites.count() > 0)
			{
			Method meth = Method.getMethod("void swapThunk(int,lava.lang.ILookupThunk)");
	...
	private void emitKeywordCallsites(GeneratorAdapter clinitgen){
		for(int i=0;i<keywordCallsites.count();i++)
			...
			clinitgen.invokeConstructor(KEYWORD_LOOKUPSITE_TYPE,
			                            Method.getMethod("void <init>(lava.lang.Keyword)"));
			clinitgen.dup();
	...
	void emitValue(Object value, GeneratorAdapter gen){
		...
		if(value == null)
			...
			gen.invokeStatic(Type.getType(Symbol.class),
							 Method.getMethod("lava.lang.Symbol intern(String,String)"));
			}
			...
			gen.invokeStatic(RT_TYPE,
							 Method.getMethod("lava.lang.Keyword keyword(String,String)"));
			}
...
//								                 Method.getMethod("lava.lang.KeywordCallSite create(lava.lang.Symbol)"));
//								}
			...
			gen.invokeStatic(RT_TYPE, Method.getMethod("lava.lang.Var var(String,String)"));
			}
			...
			if(vs == null)
				...
				gen.invokeStatic(Type.getType(PersistentHashSet.class), Method.getMethod(
					"lava.lang.PersistentHashSet create(Object[])"));
				}
			}
			...
			gen.invokeStatic(Type.getType(PersistentList.class),
							 Method.getMethod(
									 "lava.lang.IPersistentList create(java.util.List)"));
			}
		...
		if(partial)
			...
			if(value instanceof IObj && RT.count(((IObj) value).meta()) > 0)
				...
				gen.invokeInterface(IOBJ_TYPE,
				                    Method.getMethod("lava.lang.IObj withMeta(lava.lang.IPersistentMap)"));
				}
			}
	}
...
//		gen.getStatic(fntype, munge(k.sym.toString()), KEYWORD_TYPE);
	...
	Type constantType(int id){
		...
		Class c = lava.lang.Util.classOf(o);
...
public static void pushNS(){
	Var.pushThreadBindings(PersistentHashMap.create(Var.intern(Symbol.intern("lava.core"),
	                                                           Symbol.intern("*ns*")).setDynamic(), null));
}

public static void pushNSandLoader(ClassLoader loader){
	Var.pushThreadBindings(RT.map(Var.intern(Symbol.intern("lava.core"),
...
static public class NewInstanceExpr extends ObjExpr{
	...
	public Expr parse(C context, Object frm) {
		...
		IPersistentVector interfaces = ((IPersistentVector) RT.first(rform)).cons(Symbol.intern("lava.lang.IObj"));
